...
<div id="user">
<a href="http://3.1415926.xyz/blog%20v%201.3.2/index.php?rss=<?php if(isset($_COOKIE['cookieid'])){
	           $trueid=$_COOKIE['cookieid'];
			   echo $trueid;
		   }else{echo "0";} ?>" ><i class="glyphicon glyphicon-star"></i></a>
<a href="<?php 
           if(isset($_COOKIE['cookieid'])){
			   echo "http://3.1415926.xyz/blog%20v%201.3.2/myhome.php";
		   }else{echo "http://3.1415926.xyz/blog%20v%201.3.2/login.php";}
